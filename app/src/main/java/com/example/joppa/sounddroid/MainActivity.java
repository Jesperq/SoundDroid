...
import com.example.joppa.sounddroid.com.example.joppa.sounddroid.soundcloud.SoundCloud;
import com.example.joppa.sounddroid.com.example.joppa.sounddroid.soundcloud.SoundCloudService;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date date = new Date();
        service.getMostRecentSongs(dateFormat.format(date), new Callback<List<Track>>() {
            @Override
